...
model2=pickle.load(open('nb_vive.pkl','rb'))
...
def predict():
    ...
    def statement():
        if pred == 1:
            return 'Resultado: El modelo ha pronosticado con un 79% de exactitud que los síntomas descritos no colocan en riesgo su vida, pero debe cuidarse.'
        elif pred == 2:
            return 'Resultado: Debe consultar con el médico, el modelo pronosticado con un 79% de exactitud que los síntomas descritos ponen en riesgo su vida.'
